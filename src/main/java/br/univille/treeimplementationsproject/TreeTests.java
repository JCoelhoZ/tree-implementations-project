...
public class TreeTests {
	...
	public void arvoreVazia() {
		...
		assertEquals("Ã�rvore vazia nao tem root", null, tree.root());
		assertEquals("Ã�rvore vazia com tamanho 0", true, tree.size());
	}
	...
	public void replace() {
		...
		assertEquals("Ã�rvore com tamanho 2",2,tree.size());
		assertEquals("Filho com o elemento 3",new Integer(2),child.getElement());
	...
	public void parent() {
		...
		assertEquals("Ã�rvore com tamanho 2",2,tree.size());
		assertEquals("Parent Ã© o root",new Integer(2),tree.isRoot(parent));
